-- Add conversation pin feature
-- This migration adds the ability for users to pin conversations to the top of their list

-- Add is_pinned column to conversations table
ALTER TABLE conversations 
ADD COLUMN IF NOT EXISTS is_pinned boolean DEFAULT false;

-- Create index for performance on is_pinned queries
...
-- Recreate the function to include is_pinned
